...
<form name="form1" method="post" action="borrow_ok.php">
...
<tr>
	...
	<?php
		...
		// get the information of this user id from the database
	...
	<!-- display the information of the reader -->
	<table width="96%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td></td>
			<td align="left">
				<input name="Submit" type="submit" class="btn_grey" value="Borrow" onClick="return check(form1)">
			</td>
		</tr>
	</table>
