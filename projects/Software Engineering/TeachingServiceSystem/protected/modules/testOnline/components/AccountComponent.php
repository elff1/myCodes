	...
	public static function getCourses()
	{
		...
		switch($userType){
			...
			case UserAuthentication::TYPE_STUDENT:	//student
				...
				break;
//				return new CActiveDataProvider(CourseBasicInfo::model());
...
//						return new CActiveDataProvider(CourseBasicInfo::model());
	...
	public static function getUserSelectedType(){
		if(AccountComponent::getUserType()===UserAuthentication::TYPE_SYSTEM_ADMIN|AccountComponent::getUserType()===UserAuthentication::TYPE_ADMIN)
			return Yii::app()->session->get('selected_user_type');
		return AccountComponent::getUserType();
	}
