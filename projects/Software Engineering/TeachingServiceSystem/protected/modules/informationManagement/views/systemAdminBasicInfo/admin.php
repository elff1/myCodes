...
$this->breadcrumbs=array(
	...
	InformationManagementModule::t('systemAdminBasicInfo','Manage Basic Info'),
);
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('system-admin-basic-info-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1><?php echo CHtml::encode(InformationManagementModule::t('systemAdminBasicInfo', 'Manage Basic Info')); ?></h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'system-admin-basic-info-grid',
