...
$this->breadcrumbs=array(
	...
	InformationManagementModule::t('adminBasicInfo','Manage Basic Info'),
);
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('admin-basic-info-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1><?php echo CHtml::encode(InformationManagementModule::t('adminBasicInfo', 'Manage Basic Info')); ?></h1>
