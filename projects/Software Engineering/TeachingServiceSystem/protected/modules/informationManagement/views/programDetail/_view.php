<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('recommended_year')); ?>:</b>
	<?php echo CHtml::encode($data->recommended_year); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('recommended_term')); ?>:</b>
	<?php echo CHtml::encode($data->recommended_term); ?>
	<br />
